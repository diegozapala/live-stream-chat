...
ActiveRecord::Schema.define(version: 20170116115623) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "daily_awards", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "number_messages_sent"
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
    t.index ["user_id"], name: "index_daily_awards_on_user_id", using: :btree
  end
  ...
  add_foreign_key "daily_awards", "users"
